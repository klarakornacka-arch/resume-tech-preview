...
class Y extends c {
  constructor(e) {
    ...
    this.onBeforeCompile = e => {
      ...
      e.fragmentShader = e.fragmentShader.replace('* vColor;', '* vColor.rgb;');
...
const Ballpit = ({ className = '', followCursor = true, onError, ...props }) => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.info('Ballpit WebGL background is unavailable. CSS background fallback is active.');
      onError?.(error);
    }
